...
// import useCreateInvestment from "@/lib/tenstack-hooks/useCreateInvestment";
...
const InvestmentPlanCard: React.FC<InvestmentPlanCardProps> = ({ name }) => {
  ...
  //   //     {
  //   //       investmentPlanName: investmentPlan.name,
  ...
  //   //     {
  //   //       onSuccess: (data) => {
  //   //         router.push("/dashboard/await-confirmation");
  //   //       },
  //   //       onError: (error) => {
    ...
    try {
      toast.promise(
        createInvestmentMutation.mutateAsync(
          {
            amount: investmentPlan.price,
            investmentPlanName: investmentPlan.name as InvestmentNameEnum,
            imageUrl: imageData.url,
            imageId: imageData.id,
            transactionId,
            userName,
      ...
      <CardContent className="flex flex-col justify-center  items-center">
        ...
        <div className="w-full mb-4">
          ...
          <div className="flex px-4 justify-between items-center h-24 bg-orange-400 text-black mt-2">
            ...
            <div className="flex flex-row items-center justify-center gap-1">
              <p className="text-sm">
                {selectedCrypto === "none" ? (
                  <p>Choose the crypto type to transfer to</p>
                ) : (
                  cryptocurrencies.find(
                    (crypto) => crypto.name === selectedCrypto
                  )?.address || <p>Choose the crypto type to transfer to</p>
                )}
              </p>
        ...
        <div className="w-full mb-4">
          ...
          <div className="flex flex-col md:flex-row justify-between mb-2">
            ...
            <p className="text-sm">
              {investmentPlan.profitPercent}% after 40 days
            </p>
          </div>
          <div className="flex flex-col md:flex-row justify-between mb-2">
        ...
        <div className="flex flex-row items-center justify-center gap-4 w-full">
          <Button
            ...
            // disabled={
            //   !userEmail || !userName || !transactionId || !imageData?.url
            // }
